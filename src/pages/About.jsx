    ...
    <>
      ...
      <section className="py-16 lg:py-20 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 text-gray-600 leading-relaxed">
            Our backend handles QR generation, review flow management, content
            generation, analytics, multi-café dashboards, and secure cloud
            hosting on AWS.
          </p>
          <div className="mt-6 grid md:grid-cols-2 gap-4">
            {[
              "React / React Native frontend",
              "Node/Spring Boot/.NET backend",
              "AWS cloud infrastructure",
              "Real-time analytics engine",
              "Secure authentication & encryption",
              "Scalable database architecture",
            ].map((tech) => (
              <div key={tech} className="flex gap-2 p-3 rounded-lg bg-gray-50">
                <span className="text-brand-600">▸</span>
          ...
          <div className="mt-12 p-6 rounded-2xl bg-gradient-to-r from-brand-600 to-brand-700 text-white">
            ...
            <p className="mt-2 text-brand-100">Scan → Answer → Post → Grow</p>
